...
library(trawl)
```
We fit a NegBin trawl model with exponential trawl function first, before considering
a supOU trawl function.

```{r}
  data <-x
  
  #Estimate trawl function parameters
  esttrawlfct_fc <- fit_Exptrawl(data, Delta=my_Delta, plot=TRUE) #estimated trawl   function for forecasting 
  
  my_lambda <- esttrawlfct_fc$lambda
  my_lambda
  
  

  #Estimate the Lebesgue measure of the trawl set (components)
  lebA_fc_c1 <-1/my_lambda
  lebA_fc_c1
