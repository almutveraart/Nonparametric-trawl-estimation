...
for(h in 1:hrange){
  print(h)
  print(dm.test(CondMean_p_Error[,h], CondMean_Error[,h], alternative="greater", h=h, power =1))
}

#Power 2
for(h in 1:hrange){
  print(h)
  print(dm.test(CondMean_p_Error[,h], CondMean_Error[,h], alternative="greater", h=h, power =2))
}
...
for(h in 1:hrange){
  print(h)
  print(dm.test(CondMean_simple_Error[,h], CondMean_Error[,h], alternative="greater", h=h, power =1))
}

#Power 2
for(h in 1:hrange){
  print(h)
  print(dm.test(CondMean_simple_Error[,h], CondMean_Error[,h], alternative="greater", h=h, power =2))
}
